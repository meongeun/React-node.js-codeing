...
const Findid = () => {
    ...
    return (
        <div style={{ textAlign: 'center', fontFamily: 'Noto Sans', marginTop: '95px', marginLeft: '10%' }}>
            ...
            <Row>
                <Col span={12}>
                    <div className="divf">
                        <h3 style={{ float: 'left', color: '#132B99', fontWeight: 'bold' }}>간편 찾기</h3>
                        <Form onSubmit={onSubmit} style={{ padding: 10 }}>
                            ...
                            <div style={{ marginTop: 10 }}>
                                <Button type="primary" style={{ width: '438px', height: '40px', background: '#132B99' }} htmlType="submit" loading={isSigningUp}> <Link href="/findidname"><a style={{ color: '#FFFFFF' }}>아이디 찾기</a></Link></Button>
                            </div>
                        </Form>
                    </div>
                </Col>
                <Col span={12}>
                    <div className="divf">
                        <h3 style={{ float: 'left', color: '#132B99', fontWeight: 'bold' }}>인증 기관을 통해 찾기</h3>
    ...
    인증 이외의 용도로 이용 또는 저장하지 않습니다. </h4>
                        ...
                        <div style={{ marginTop: 10, boxSizing:'border-box', textAlign:'left'}}>
                            ...
                            <label style={{ border: '0.4px solid #464646', paddingRight:'360px', width: '438px', background:'linear-gradient(180deg, #FFFFFF 0%, rgba(255, 255, 255, 0) 100%), #FFFFFF'}}>
                                휴대폰 인증</label>
                            <Button type="primary" style={{ width: '438px', height: '40px', background: '#132B99' }}> <Link href="/findidemail"><a style={{ color: '#FFFFFF' }}>아이디 찾기</a></Link></Button>
                        </div>
                    </div>
                </Col>
            </Row>
